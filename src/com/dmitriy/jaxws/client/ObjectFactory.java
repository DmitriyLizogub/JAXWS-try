 ...
 * generated in the com.dmitriy.jaxws.jaxws.orderprocess package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessOrder_QNAME = new QName("http://jaxws.dmitriy.com/jaxws/orderprocess", "processOrder");
    private final static QName _ProcessOrderResponse_QNAME = new QName("http://jaxws.dmitriy.com/jaxws/orderprocess", "processOrderResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.dmitriy.jaxws.jaxws.orderprocess
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.dmitriy.com/jaxws/orderprocess", name = "processOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.dmitriy.com/jaxws/orderprocess", name = "processOrderResponse")
