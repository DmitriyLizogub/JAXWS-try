 ...
 * 
 */
@WebServiceClient(name = "OrderProcess", targetNamespace = "http://jaxws.dmitriy.com/jaxws/orderprocess", wsdlLocation = "http://localhost:8081/OrderProcessWeb/OrderProcess.wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERPROCESS_QNAME = new QName("http://jaxws.dmitriy.com/jaxws/orderprocess", "OrderProcess");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/OrderProcessWeb/OrderProcess.wsdl");
    ...
    public OrderProcessService getOrderProcessPort() {
        return super.getPort(new QName("http://jaxws.dmitriy.com/jaxws/orderprocess", "OrderProcessPort"), OrderProcessService.class);
    }
    ...
    public OrderProcessService getOrderProcessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.dmitriy.com/jaxws/orderprocess", "OrderProcessPort"), OrderProcessService.class, features);
    }
