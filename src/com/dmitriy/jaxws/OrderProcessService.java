package com.dmitriy.jaxws;


import com.dmitriy.jaxws.bean.OrderBean;
...
//WSDL, равен "http://jaxws.dmitriy.com/jaxws/orderprocess".
@WebService(serviceName = "OrderProcess",
        portName = "OrderProcessPort",
        targetNamespace = "http://jaxws.dmitriy.com/jaxws/orderprocess")
